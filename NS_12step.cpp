...
// Assuming you have included necessary headers for vectors and other operations
...
int main() {
    ...
    */
    ...
    // Populate x vector with linspace values
    for (int i = 0; i < nx; ++i) {
        x[i] = start_x + i * (end_x - start_x) / (nx - 1);
    }

    // Populate y vector with linspace values
    for (int i = 0; i < ny; ++i) {
