...
nx = nx_a(k); % number of grid points
h = 0.15; % bump height
...
legend('Grid points = 25','Grid points = 50','Grid points = 100','Grid points = 200');
hold on; 
% 
% % Density residual
% 
